...
<body class="bg-white">
  ...
  <section>
    <div class="flex items-center h-[calc(100vh-52px)] mx-auto">
      <div class="grid grid-rows-4 grid-cols-10">
        <div class="col-start-4 col-span-6">
          <p class="text-7xl  " style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">Crafting Futures</p>
        </div>

        <div class="col-span-4 grid justify-items-end ">
          <p class="text-7xl" style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">Through</p>
        </div>
        <div class="col-start-7 col-span-3 grid justify-items-end ">
          <p class="text-sm " style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">"Fueling success, from SEO precision to captivating web design. Our digital artistry ensures simplicity meets impact. Join us in crafting your unique online story."</p>
        </div>

        <div class="col-start-5 col-span-6 ">
          <p class="text-7xl" style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">Digital</p>
        </div>

        <div class="col-start-6 col-span-2 ">
          <p class="text-7xl" style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">Mastery</p>
        </div>

        <div class="col-start-4 col-span-4 ">
          <p class="text-sm" style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">"Digital Symphony: Web Aesthetics, SEO Harmony, Dev Mastery."</p>
        </div>


      </div>

      <span class="h-[43rem] w-[2rem] bg-white z-50 rotate-45 absolute right-1/2 mix-blend-exclusion"></span>

      <!-- go down -->
      <img class="absolute  bottom-0 right-3 animate-bounce justify-items-center" src="./src/images/arrow-down.svg.png" alt="">
...
<!-- ------------------------------------------------------------------------------------------------------------------------- -->
  <section>
    <div class=" relative flex flex-col justify-center items-center overflow-hidden -z-10 ">
      <div class=" absolute rounded-t-full w-[500vh] h-[270vh] bg-black"></div>
      <!-- about -->
       <div class="container w-2/3 pt-20 relative mx-auto "><!-- -mt-[270vh] -->
        ...
        <div class="container w-full mx-auto pt-10">
          ...
          <p class=" hover:text-whitepublic/index.php " style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">
        ...
        <div class=" flex justify-center justify-items-center w-1/3 mx-auto py-6">
          <span class="flex justify-center items-center w-36 h-36 bg-slate-500 rounded-full hover:bg-gray-900 hover:text-gray-50">Learn more</span>
        </div>

        <!-- image -->
        <div class=" relative flex flex-col justify-center items-center">
          <img class=" w-1/3 h-auto" src="./src/images//section-image-1.jpg" alt="">
          <p class=" absolute text-8xl text-white text-center" style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">ESTABLISHED IN 2019</p>
          <p class=" relative text-xl text-white text-center" style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">WE BELIEVE THAT THINGS SHOULD BE USEFUL YET BEAUTIFUL.</p>
  ...
  <section>
    <div class="flex flex-col justify-center items-center container w-11/12 mx-auto py-6">
      ...
      <div class=" m-auto grid grid-cols-12 grid-rows-5 text-8xl py-10" style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">
        <div class=" col-start-3 col-span-9 hover:animate-pulse">BRANDING</div>
        <div class=" col-start-3 col-span-9 hover:animate-pulse">UI/UX DESIGN</div>
      ...
      <div class="flex justify-between w-2/3 items-center">
        <span class="text-sm w-1/3">WE USE THE POWER OF DESIGN TO SOLVE COMPLEX PROBLEMS AND CULTIVATE BUSINESS SOLUTIONS.</span>
        <a href="#" class="baseline border-2 rounded-full border-black px-3 py-1 hover:bg-gray-400 hover:shadow-2xl shrink-0 hidden lg:flex">GET A PROPOSAL</a>
  ...
  <section>
    <div class="flex flex-col justify-center items-center container w-11/12 mx-auto py-6">
      ...
      <div class=" m-auto grid grid-cols-12 grid-rows-2 text-8xl py-10" style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">
      ...
      <div class=" m-auto grid grid-cols-3 grid-rows-5 text-2xl py-10 gap-y-20" style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">

        <div class="flex justify-end items-baseline col-start-1 col-span-2"><img class="w-2/3 rounded-3xl" src="./src/images/1 (1).jpg" alt=""></div>
        <div class=" flex flex-col justify-end items-center col-start-3">
          <span>MEDIUM SCENE</span>
          <span class="text-sm">BRANDING, DESIGN</span>
        </div>


        <div class="flex flex-col justify-end items-centercol-start-1 ">
          <span>THE RISE OF DESIGN</span>
          <span class="text-sm">BRANDING, DESIGN</span>
        </div>
        <div class="flex justify-start items-baseline col-start-2 col-span-2"><img class="w-2/3 rounded-3xl" src="./src/images/2 (1).jpg" alt=""></div>

        <div class="flex justify-end items-baseline col-start-1 col-span-2"><img class="w-2/3 rounded-3xl" src="./src/images/3 (1).jpg" alt=""></div>
        <div class="flex flex-col justify-end items-center col-start-3">
        ...
        <div class="flex justify-start items-baseline col-start-2 col-span-2"><img class="w-2/3 rounded-3xl" src="./src/images/4 (1).jpg" alt=""></div>




        <div class="flex justify-end items-baseline col-start-1 col-span-2"><img class="w-2/3 rounded-3xl" src="./src/images/5 (1).jpg" alt=""></div>
        <div class="flex flex-col justify-end items-center col-start-3">
  ...
  <section>
    ...
    <div class="flex justify-between w-full">
      ...
      <div class="grid grid-cols-12 grid-rows-3 w-full m-auto ">
        <span class="flex flex-col items-center col-start-1 col-span-3 "><img class="rounded-3xl" src="./src/images/1 (1).jpg" alt=""><p class="text-sm">Natura Insects Series</p><p class="text-xs">DECEMBER 3, 2023</p></span>
        <span class="flex flex-col items-center col-start-10 col-span-3"><img class="rounded-3xl" src="./src/images/2 (1).jpg" alt=""><p class="text-sm">Natura Insects Series</p><p class="text-xs">DECEMBER 3, 2023</p></span>
        <span class="col-start-5 col-span-4"><img class="rounded-3xl" src="./src/images/3 (1).jpg" alt=""></span>
        
        
        
        <div class="flex flex-col items-center col-start-5 col-span-4"><p class="text-sm">Natura Insects Series</p><p class="text-xs">DECEMBER 3, 2023</p></div>

        <!-- <div class="col-span-12 bg-blue-500">Bye</div>
        <div class="col-span- bg-green-500">Tata</div> -->
      </div>
      ...
      <div class="flex flex-col justify-start w-2/3">
        ...
        <div class="flex justify-start w-full py-10">
          <input class="w-2/3 focus-visible:outline-none border-b-2 text-2xl" type="text" placeholder="ENTER YOUR EMAIL">
          <a href="#" class="baseline border-2 rounded-full border-black px-3 py-1 mx-4 hover:bg-gray-400 hover:shadow-2xl shrink-0 hidden lg:flex">GET A PROPOSAL</a>
      </div>
      <p> By sending the form you agree to the Terms & Conditions and Privacy Policy.</p>
  ...
  <div class="flex flex-col justify-center items-center w-11/12 mx-auto py-6">
    <div class="flex justify-between w-full">
        <span>REVIEWS</span>
        <a href="#"><span>EXPLORE REVIEWS<i class="fa-solid fa-arrow-right-long fa-lg" style="color: #000000;"></i></span></a>
      </div>
      <hr class=" w-full my-3 pt-1 bg-black ">
      ...
      <div class="grid grid-cols-12 grid-rows-2 w-full m-auto " style="font-family: 'Climate Crisis', sans-serif;font-family: 'Inter', sans-serif;">
        <!-- raw one -->
      <div class="flex flex-row col-start-1 col-span-6">
          <img class="rounded-3xl" src="./src/images/testimonial-1.jpg" alt="">
        </div>
        <div class="flex flex-col items-center justify-center col-start-8 col-span-5">
          <p class="text-xl">
        ...
        <div class="flex flex-col items-center justify-center col-start-1 col-span-5">
          ...
          <div class="flex flex-row col-start-7 col-span-6">
    ...
    <div class="flex justify-between w-full">
      ...
      <div class="w-full grid grid-cols-3">
        <div class=" col-start-1">
          <p>WE’RE OPEN TO TALK TO GOOD PEOPLE. JUST SAY HELLO AND WE’LL START A PRODUCTIVE COOPERATION.</p>
          <div class="py-6">          
        ...
        <div class=" ml-3 col-start-2 col-span-2 container">
          <form class="flex flex-col" action="">
            <div class=" container grid grid-col-2 justify-between pb-5 w-2/3">            
              <input class=" col-start-1 mr-1 p-2 rounded-xl border-2 border-black text-xl focus-visible:outline-none" type="text" placeholder="NAME">
              <input class=" col-start-2  p-2 rounded-xl border-2 border-black text-xl focus-visible:outline-none" type="text" placeholder="EMAIL">
            </div>
            ...
            <div class=" flex flex-row justify-between items-center py-5">
              <button name="submit" class="baseline border-2 rounded-full border-black px-3 py-1 hover:bg-gray-400 hover:shadow-2xl shrink-0 hidden lg:flex">SUBMIT</button>
  ...
  <section class="w-full bg-gray-700">
    <div class="grid grid-rows-1 w-11/12 mx-auto justify-between mt-4 pt-5">
